...
export const classicTheme: Theme = {
  ...
  resultsHeader: {
    wrapper: 'sticky top-0 z-30 rounded-t-xl border-b border-gray-200 bg-white p-4 text-sm text-gray-600 sm:p-5',
  ...
  refinementCard: {
    wrapper: 'space-y-4 border-t border-gray-200 bg-gray-50 p-4 sm:p-5',
...
export const midnightTheme: Theme = {
  ...
  resultsHeader: {
    wrapper: 'sticky top-0 z-30 rounded-t-2xl border-b border-zinc-800 bg-zinc-900/90 p-4 text-sm text-zinc-400 backdrop-blur-xl sm:p-5',
  ...
  refinementCard: {
    wrapper: 'space-y-4 border-t border-zinc-800 bg-zinc-900/80 p-4 sm:p-5',
