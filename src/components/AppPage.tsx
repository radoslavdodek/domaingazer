            ...
            <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-gray-500 dark:text-zinc-400">
                ...
                <div className="flex items-center gap-2">
                  <a href="https://github.com/radoslavdodek/domaingazer" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600 dark:text-zinc-500 dark:hover:text-zinc-300 transition-colors" aria-label="View on GitHub">
