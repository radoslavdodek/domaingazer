          ...
          <div className="flex flex-col items-center gap-3 sm:items-end">
            <div className="flex flex-wrap items-center justify-center gap-3 text-xs text-zinc-300">
              ...
              <div className="flex items-center gap-2">
                <a href="https://github.com/radoslavdodek/domaingazer" target="_blank" rel="noopener noreferrer" className={`inline-flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full text-zinc-300 transition-colors hover:text-zinc-100 ${focusRingClassName}`} aria-label="View on GitHub">
