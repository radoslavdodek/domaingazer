...
- [x] Add more TLD options, maybe add "other" option where user can search for a TLD
- [x] Add the ability for the user to share information about this website (domaingazer.com)
- [x] Add the ability to assume identity of the user (only admins should be able to do this)
- [x] Track individual user sessions - Currently using Microsoft Clarity
- [x] Add the ability for the user to give feedback
